...
files <- list(
  list(input = "MPV.out", output = "MPV_Europeans_GWAMA_buildGRCh37_selectedcols_0.5pcMAF.tsv.gz"),
  list(input = "PLT.out", output = "PLT_Europeans_GWAMA_buildGRCh37_selectedcols_0.5pcMAF.tsv.gz"))
