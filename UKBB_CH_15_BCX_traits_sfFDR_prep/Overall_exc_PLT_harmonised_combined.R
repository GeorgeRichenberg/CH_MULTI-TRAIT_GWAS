...
### Load data:
overall_plt <- vroom("overall_PLT_harmonised.tsv.gz", col_select = c(SNP, rsid, CHR, BP, ea_overall, oa_overall, eaf_overall, beta_overall, se_overall, pval_overall, new_ea_bcx, new_oa_bcx, new_eaf_bcx, new_beta_bcx, se_bcx, pval_bcx, n_studies_bcx, n_samples_bcx))
overall_mpv <- vroom("overall_MPV_harmonised.tsv.gz", col_select = c(SNP, new_ea_bcx, new_oa_bcx, new_eaf_bcx, new_beta_bcx, se_bcx, pval_bcx, n_studies_bcx, n_samples_bcx))
...
### Save output:
vroom_write(overall_bcx, file = "overall_bcx_platelet_harmonised_combined.tsv.gz")